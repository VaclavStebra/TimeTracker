...
class UserAddressesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_address" do
    assert_difference('UserAddress.count') do
      post user_addresses_url, params: { user_address: { address_line: @user_address.address_line, address_line_2: @user_address.address_line_2, city: @user_address.city, country: @user_address.country, primary: @user_address.primary, state: @user_address.state, user_id: @user_address.user_id, zip_code: @user_address.zip_code } }
    end
  ...
  test "should update user_address" do
    patch user_address_url(@user_address), params: { user_address: { address_line: @user_address.address_line, address_line_2: @user_address.address_line_2, city: @user_address.city, country: @user_address.country, primary: @user_address.primary, state: @user_address.state, user_id: @user_address.user_id, zip_code: @user_address.zip_code } }
